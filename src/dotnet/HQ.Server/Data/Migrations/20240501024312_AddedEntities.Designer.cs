...
namespace HQ.Server.Data.Migrations
{
    ...
    [Migration("20240501024312_AddedEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HQ.Server.Data.Models.ChargeCode", b =>
                {
                    ...
                    b.HasIndex("ServiceId")
                        .HasDatabaseName("ix_charge_codes_service_id");
            ...
            modelBuilder.Entity("HQ.Server.Data.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("HQ.Server.Data.Models.ChargeCode", b =>
                {
                    ...
                    b.HasOne("HQ.Server.Data.Models.Service", "Service")
                        .WithMany()
                        .HasForeignKey("ServiceId")
                        .HasConstraintName("fk_charge_codes_services_service_id");
            ...
            modelBuilder.Entity("HQ.Server.Data.Models.User", b =>
                {
                    ...
                    b.HasOne("HQ.Server.Data.Models.Staff", "Staff")
                        .WithMany()
                        .HasForeignKey("StaffId")
                        .HasConstraintName("fk_users_staff_staff_id");
